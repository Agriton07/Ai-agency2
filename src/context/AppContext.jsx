...
const translations = {
  en: {
    ...
    about: {
      ...
      subtitle:
        "We're Justin, Alexander, and Adrian — three builders who saw how much businesses lose to manual work that AI can replace, and decided to do something about it.",
      story:
        "AKJ.ai was built on one belief: powerful AI automation shouldn't require enterprise budgets or six-month timelines. We build lean, we move fast, and we stay until your system delivers real, measurable results.",
      values: [
      ...
      founders: [
        { name: "Justin Kuijper",    role: "Co-Founder", specialty: "AI Chatbots & Lead Systems",   initials: "JK" },
        { name: "Alexander Janssen", role: "Co-Founder", specialty: "Voice AI & Integrations",       initials: "AJ" },
        { name: "Adrian Alvarez",    role: "Co-Founder", specialty: "Automation & Operations",       initials: "AA" },
      ],
  ...
  es: {
    ...
    about: {
      ...
      founders: [
        { name: "Justin Kuijper",    role: "Co-Fundador", specialty: "Chatbots IA y captación de leads", initials: "JK" },
        { name: "Alexander Janssen", role: "Co-Fundador", specialty: "Voz IA e integraciones",           initials: "AJ" },
        { name: "Adrian Alvarez",    role: "Co-Fundador", specialty: "Automatización y operaciones",      initials: "AA" },
      ],
  ...
  nl: {
    ...
    about: {
      ...
      founders: [
        { name: "Justin Kuijper",    role: "Medeoprichter", specialty: "AI-chatbots & leadsystemen",    initials: "JK" },
        { name: "Alexander Janssen", role: "Medeoprichter", specialty: "Spraak-AI & integraties",        initials: "AJ" },
        { name: "Adrian Alvarez",    role: "Medeoprichter", specialty: "Automatisering & operaties",     initials: "AA" },
      ],
