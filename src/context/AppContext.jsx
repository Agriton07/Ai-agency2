...
const translations = {
  en: {
    ...
    hero: {
      ...
      trust1: "Free discovery call",
      trust2: "No commitment",
      trust3: "Response in 24 h",
    },
    services: {
      badge: "What we build",
    ...
    useCases: {
      ...
      ctaTitle: "Let's map out yours in",
      ctaAccent: "30 minutes.",
      ctaBtn: "Book a free call",
    },
    socialProof: {
      badge: "Why AKJ.ai",
      title: "What makes us different",
      titleAccent: "from every other agency",
      subtitle:
        "We built this agency to fix what's broken about how AI projects are sold and delivered.",
      diff1Title: "Fixed price. Always.",
      diff1Desc: "No hourly billing. No scope creep. You get a clear price before we start — and that's exactly what you pay. Period.",
      diff2Title: "Live in 1–3 weeks",
      diff2Desc: "Not months, not quarters. Our streamlined build process gets your AI system deployed, tested, and running faster than any traditional agency.",
      diff3Title: "Direct founder access",
      diff3Desc: "You work directly with Justin, Alexander, or Adrian — the people who built your system. Not a junior account manager you've never met.",
      diff4Title: "Built around your business",
      diff4Desc: "We don't sell pre-packaged templates. Every system is architected from scratch around your exact workflows, tools, and business logic.",
      commitTitle: "Our commitments to every client",
      commits: [
        "Fixed-price contracts — no surprises, ever",
        "You own 100% of everything we build",
        "30-day post-launch monitoring included",
        "ROI-focused delivery, not billable hours",
        "Direct line to the founders, always",
      ],
    },
    about: {
      badge: "Who we are",
      ...
      subtitle:
        "Three Honours students at Amsterdam University College — different disciplines, same standard: build things that actually work.",
      story:
        "We started AKJ.ai after watching businesses hemorrhage time and revenue on manual tasks that AI could handle in seconds. No consultancy deck. No six-month roadmaps. We scope it, build it, and ship it — fixed price, in weeks. Adrián brings the engineering precision of a competitive athlete. Justin brings Michelin-level operational discipline. Alexander brings the commercial strategy. Together: fast, precise, and uncompromising.",
      values: [
        { icon: "⚡", title: "Ships in weeks, not months", desc: "Most projects go live in 1–3 weeks. We've optimized every part of our build process for speed without cutting corners." },
        { icon: "💡", title: "Fixed price. Always.", desc: "You know the cost before we write a single line. No scope creep, no surprise invoices, no billable-hour games." },
        { icon: "🤝", title: "Founders on every project", desc: "You talk directly to the person who built your system — not an account manager who saw a demo last Tuesday." },
      ],
      founders: [
        {
          name: "Adrián Álvarez Sande",
          role: "Co-Founder & CEO",
          specialty: "AI Engineering & Systems Architecture",
          bio: "Math, Technology & Economics at AUC. Competitive tennis athlete. Builds the AI infrastructure powering every client system.",
          initials: "AÁ",
        ...
        },
        {
          name: "Justin Kuijper",
          role: "Co-Founder & COO",
          specialty: "Strategy & Client Success",
          bio: "Math & Economics at AUC · GPA 8.5. Brings Michelin-level precision to every delivery. Owns client strategy and operations.",
          initials: "JK",
          school: "Amsterdam University College",
        },
        {
          name: "Alexander",
          role: "Co-Founder & CBO",
          specialty: "Growth & Business Development",
          bio: "Social Sciences & Economics at AUC. Drives partnerships, client relationships, and commercial growth.",
          initials: "AK",
          school: "Amsterdam University College",
        },
      ],
    ...
    faq: {
      ...
      ctaDesc: "Book a free 30-minute call and we'll answer everything — no pitch, just clarity.",
      ctaBtn: "Book a free call",
      items: [
        {
    ...
    contact: {
      ...
      extraLabel: "What process takes the most of your time right now?",
      extraPh: "e.g. Reporting, onboarding, lead follow-up…",
      emails: [
    ...
    footer: {
      ...
      brandDesc:
        "AI automation agency built by Adrián Álvarez Sande, Justin Kuijper, and Alexander.",
    ...
    home: {
      metrics: [
        { value: "1–3 wks",  label: "Average launch timeline" },
        { value: "60%+",     label: "Reduction in manual tasks" },
        { value: "24 / 7",   label: "AI agents always on" },
      ...
      servicesGrid: {
        ...
        subtitle: "Seven proven AI systems, any business, any industry. Pick what you need — we build and connect it all.",
        cta: "View all 7 services",
        learnMore: "Learn more",
        tiles: [
          { label: "AI Chatbots",          desc: "Web, WhatsApp & social media" },
          { label: "AI Voice Agents",       desc: "Automated phone call handling" },
          { label: "Workflow Automation",   desc: "End-to-end process automation" },
          { label: "CRM & Lead Mgmt",       desc: "Capture, score & follow up" },
          { label: "Appointment Booking",   desc: "24/7 self-service booking" },
          { label: "API Integrations",      desc: "Stripe, Notion, HubSpot & more" },
          { label: "Custom AI Agents",      desc: "Built around your exact business" },
        ],
      },
      process: {
        badge: "Our process",
        title: "Simple process.",
        titleAccent: "fast results.",
        subtitle: "Four steps from first conversation to a live AI system — no surprises, no delays.",
        prev: "← Previous",
        next: "Next →",
        steps: [
          { num: "01", title: "Free discovery call", desc: "30 minutes. We learn your business, map out what can be automated, and check if we're a fit.", detail: "You'll leave the call knowing exactly which systems make sense for your business and what ROI looks like — even if you don't hire us." },
          { num: "02", title: "Custom proposal",     desc: "A clear plan: what we build, how it works, the price, and the timeline. No vague scope.", detail: "Fixed price, clear deliverables, no upsells. We scope the project tightly so both sides know what success looks like." },
          { num: "03", title: "Build & integrate",   desc: "We build your AI system, connect it to your tools, and test everything before launch.", detail: "All integrations are tested end-to-end in a staging environment before touching your live data. We handle the entire technical layer." },
          { num: "04", title: "Launch & support",    desc: "Live in 1–3 weeks. 30 days of post-launch monitoring and adjustments included.", detail: "After launch, we monitor performance, fix edge cases, and tune the system. You get a working product, not a finished deliverable." },
        ],
      },
      pricingTeaser: {
        badge: "Pricing",
        title: "Simple,",
        titleAccent: "transparent pricing",
        subtitle: "Fixed-price projects. No hidden fees. No monthly subscriptions. Pick your scope.",
        cta: "See full pricing & deliverables",
        popularBadge: "Most popular",
        tiers: [
          { name: "Starter",  price: "€150 – €400",   desc: "First AI automation. One problem solved, fast.",         cta: "Get started" },
          { name: "Growth",   price: "€400 – €900",   desc: "Multiple systems working together to save hours.",       cta: "Get started", featured: true },
          { name: "Business", price: "€900 – €2,000", desc: "Full AI ecosystem for a scalable operation.",           cta: "Get started" },
        ],
      },
      useCasesTeaser: {
        badge: "Use Cases",
        title: "What businesses",
        titleAccent: "actually automate",
        subtitle: "Real scenarios. Real outcomes. No industry is off-limits.",
        cta: "See all 6 use cases",
        items: [
      ...
      cta: {
        ...
        title: "Book a free",
        titleAccent: "30-minute call.",
        desc: "We'll map out exactly what AI can do for your business. No commitment, no pitch — just a clear conversation.",
        btn1: "Book a free call",
        btn2: "See our services",
        social: "Typically responds within 24 hours",
      },
      liveDemo: {
        badge: "Watch it work",
        title: "Your AI responds while",
        titleAccent: "you sleep.",
        subtitle: "A customer messages at 11pm. Your AI qualifies, responds, and books — in seconds. No human needed.",
        eventLabel: "Automated actions",
        statText: "All of this happened in under 8 seconds — automatically, while you were unavailable.",
  ...
  es: {
    ...
    hero: {
      ...
      trust1: "Llamada de descubrimiento gratis",
    ...
    useCases: {
      ...
      ctaTitle: "Trazamos el tuyo en",
      ctaAccent: "30 minutos.",
      ctaBtn: "Reservar llamada gratis",
    },
    socialProof: {
      badge: "Por qué AKJ.ai",
      title: "Lo que nos diferencia",
      titleAccent: "de cualquier otra agencia",
      subtitle:
        "Creamos esta agencia para corregir lo que está roto en cómo se venden y entregan los proyectos de IA.",
      diff1Title: "Precio fijo. Siempre.",
      diff1Desc: "Sin facturación por horas. Sin sobrecostes. Recibes un precio claro antes de empezar — y eso es exactamente lo que pagas.",
      diff2Title: "En producción en 1–3 semanas",
      diff2Desc: "No meses ni trimestres. Nuestro proceso optimizado hace que tu sistema IA esté desplegado, probado y funcionando más rápido que cualquier agencia tradicional.",
      diff3Title: "Acceso directo a los fundadores",
      diff3Desc: "Trabajas directamente con Justin, Alexander o Adrian — las personas que construyeron tu sistema. No un gestor de cuenta junior al que nunca has visto.",
      diff4Title: "Construido para tu negocio",
      diff4Desc: "No vendemos plantillas prefabricadas. Cada sistema se diseña desde cero en torno a tus flujos, herramientas y lógica de negocio exactos.",
      commitTitle: "Nuestros compromisos con cada cliente",
      commits: [
        "Contratos a precio fijo — sin sorpresas",
        "Eres dueño del 100% de lo que construimos",
        "30 días de monitorización post-lanzamiento incluidos",
        "Entrega orientada al ROI, no a horas facturables",
        "Línea directa con los fundadores, siempre",
      ],
    },
    about: {
      badge: "Quiénes somos",
      title: "3 fundadores.",
      titleAccent: "Cero compromiso.",
      subtitle: "Somos Justin, Alexander y Adrian — tres builders que vieron cuánto pierden los negocios con trabajo manual que la IA puede reemplazar, y decidieron hacer algo al respecto.",
      story: "AKJ.ai nació con una convicción: la automatización IA potente no debería requerir presupuestos de gran empresa ni plazos de seis meses. Construimos con eficiencia, avanzamos rápido y nos quedamos hasta que tu sistema genera resultados reales y medibles.",
      values: [
      ...
      founders: [
        {
          ...
          specialty: "Ingeniería IA y Arquitectura de Sistemas",
          bio: "Matemáticas, Tecnología y Economía en AUC. Tenista competitivo. Construye la infraestructura IA de cada cliente.",
          initials: "AÁ",
          school: "Amsterdam University College",
        },
        {
          ...
          specialty: "Estrategia y Éxito del Cliente",
          bio: "Matemáticas y Economía en AUC · Nota 8.5. Precisión de estrella Michelin en cada entrega. Gestiona estrategia y operaciones.",
          initials: "JK",
          school: "Amsterdam University College",
        },
        {
          name: "Alexander",
          role: "Co-Fundador & CBO",
          specialty: "Crecimiento y Desarrollo de Negocio",
          bio: "Ciencias Sociales y Economía en AUC. Impulsa alianzas, relaciones con clientes y crecimiento comercial.",
          initials: "AK",
          school: "Amsterdam University College",
        },
      ],
    ...
    faq: {
      ...
      ctaDesc: "Reserva una llamada gratuita de 30 minutos y te respondemos todo — sin pitch, solo claridad.",
      ctaBtn: "Reservar llamada gratis",
      items: [
        {
    ...
    contact: {
      ...
      extraLabel: "¿Qué proceso te quita más tiempo ahora mismo?",
      extraPh: "p. ej. Informes, incorporación, seguimiento de leads…",
      emails: [
    ...
    footer: {
      ...
      brandDesc: "Agencia de automatización IA fundada por Adrián Álvarez Sande, Justin Kuijper y Alexander.",
    ...
    home: {
      metrics: [
        { value: "1–3 sem",  label: "Tiempo medio de lanzamiento" },
        { value: "60%+",     label: "Reducción de trabajo manual" },
        { value: "24 / 7",   label: "Agentes IA siempre activos" },
        { value: "100+",     label: "Automatizaciones desplegadas" },
      ],
      servicesGrid: {
        badge: "Lo que automatizamos",
        title: "Sistemas IA construidos",
        titleAccent: "para cada negocio",
        subtitle: "Siete sistemas IA probados, cualquier negocio, cualquier sector. Elige lo que necesitas — nosotros lo construimos y conectamos todo.",
        cta: "Ver los 7 servicios",
        learnMore: "Saber más",
        tiles: [
          { label: "Chatbots IA",               desc: "Web, WhatsApp y redes sociales" },
          { label: "Agentes de Voz IA",          desc: "Gestión automática de llamadas" },
          { label: "Automatización",             desc: "Automatización de procesos completa" },
          { label: "CRM y Leads",                desc: "Captura, puntúa y da seguimiento" },
          { label: "Reserva de Citas",           desc: "Reservas self-service 24/7" },
          { label: "Integraciones API",          desc: "Stripe, Notion, HubSpot y más" },
          { label: "Agentes IA Personalizados",  desc: "Diseñado para tu negocio exacto" },
        ],
      },
      process: {
        badge: "Nuestro proceso",
        title: "Proceso simple.",
        titleAccent: "resultados rápidos.",
        subtitle: "Cuatro pasos desde la primera conversación hasta un sistema IA en vivo — sin sorpresas, sin retrasos.",
        prev: "← Anterior",
        next: "Siguiente →",
        steps: [
          { num: "01", title: "Llamada de descubrimiento gratuita", desc: "30 minutos. Conocemos tu negocio, identificamos qué se puede automatizar y verificamos si encajamos.", detail: "Saldrás sabiendo exactamente qué sistemas tienen sentido para tu negocio y cómo se ve el ROI — incluso si no nos contratas." },
          { num: "02", title: "Propuesta personalizada",           desc: "Un plan claro: qué construimos, cómo funciona, el precio y el plazo. Sin alcance vago.", detail: "Precio fijo, entregables claros, sin upsells. Delimitamos el proyecto para que ambas partes sepan cómo es el éxito." },
          { num: "03", title: "Construcción e integración",        desc: "Construimos tu sistema IA, lo conectamos con tus herramientas y probamos todo antes del lanzamiento.", detail: "Todas las integraciones se prueban de extremo a extremo en un entorno de prueba antes de tocar tus datos en vivo." },
          { num: "04", title: "Lanzamiento y soporte",             desc: "En vivo en 1–3 semanas. 30 días de monitorización y ajustes post-lanzamiento incluidos.", detail: "Tras el lanzamiento, monitorizamos el rendimiento, corregimos casos extremos y ajustamos el sistema." },
        ],
      },
      pricingTeaser: {
        badge: "Precios",
        ...
        subtitle: "Proyectos a precio fijo. Sin costes ocultos. Sin suscripciones mensuales. Elige tu alcance.",
        cta: "Ver precios completos y entregables",
        popularBadge: "Más popular",
        tiers: [
          { name: "Starter",  price: "€150 – €400",   desc: "Primera automatización IA. Un problema resuelto, rápido.",       cta: "Empezar" },
          { name: "Growth",   price: "€400 – €900",   desc: "Varios sistemas trabajando juntos para ahorrar horas.",          cta: "Empezar", featured: true },
          { name: "Business", price: "€900 – €2.000", desc: "Ecosistema IA completo para una operación escalable.",           cta: "Empezar" },
        ],
      },
      useCasesTeaser: {
        badge: "Casos de uso",
      ...
      cta: {
        ...
        title: "Reserva una",
        titleAccent: "llamada gratuita de 30 min.",
        desc: "Trazaremos exactamente qué puede hacer la IA por tu negocio. Sin compromiso, sin pitch — solo una conversación clara.",
        btn1: "Reservar llamada gratis",
        btn2: "Ver nuestros servicios",
        social: "Respondemos en menos de 24 horas",
      },
      liveDemo: {
        badge: "Míralo en acción",
        title: "Tu IA responde mientras",
        titleAccent: "tú duermes.",
        subtitle: "Un cliente escribe a las 11 de la noche. Tu IA califica, responde y reserva — en segundos. Sin intervención humana.",
        eventLabel: "Acciones automatizadas",
        statText: "Todo esto ocurrió en menos de 8 segundos — automáticamente, mientras no estabas disponible.",
        cta: "Construir esto para mi negocio",
      },
    },
  },
  ...
  nl: {
    ...
    hero: {
      ...
      trust1: "Gratis ontdekkingsgesprek",
      trust2: "Geen verplichting",
      trust3: "Reactie binnen 24 u",
    },
    services: {
      badge: "Wat we bouwen",
    ...
    useCases: {
      ...
      ctaTitle: "We brengen uw situatie in kaart in",
      ctaAccent: "30 minuten.",
      ctaBtn: "Boek een gratis gesprek",
    },
    socialProof: {
      badge: "Waarom AKJ.ai",
      title: "Wat ons onderscheidt",
      titleAccent: "van elk ander bureau",
      subtitle:
        "We bouwden dit bureau om te herstellen wat er mis is aan hoe AI-projecten worden verkocht en geleverd.",
      diff1Title: "Vaste prijs. Altijd.",
      diff1Desc: "Geen uurtarieven. Geen meerwerk. U krijgt een heldere prijs vóór de start — en dat is precies wat u betaalt.",
      diff2Title: "Live in 1–3 weken",
      diff2Desc: "Geen maanden of kwartalen. Ons gestroomlijnde bouwproces zorgt dat uw AI-systeem sneller wordt ingezet, getest en actief is dan bij welk traditioneel bureau dan ook.",
      diff3Title: "Directe toegang tot de oprichters",
      diff3Desc: "U werkt rechtstreeks met Justin, Alexander of Adrian — de mensen die uw systeem hebben gebouwd. Geen junior accountmanager die u nooit heeft gezien.",
      diff4Title: "Gebouwd voor uw bedrijf",
      diff4Desc: "Wij verkopen geen kant-en-klare sjablonen. Elk systeem wordt vanaf nul ontworpen rondom uw exacte werkstromen, tools en bedrijfslogica.",
      commitTitle: "Onze toezeggingen aan elke klant",
      commits: [
        "Vaste-prijscontracten — nooit verrassingen",
        "U bent eigenaar van 100% van wat we bouwen",
        "30 dagen monitoring na lancering inbegrepen",
        "ROI-gerichte levering, geen factureerbare uren",
        "Directe lijn naar de oprichters, altijd",
      ],
    },
    about: {
      badge: "Wie wij zijn",
      title: "3 oprichters.",
      titleAccent: "Nul compromis.",
      subtitle: "Wij zijn Justin, Alexander en Adrian — drie bouwers die zagen hoeveel bedrijven verliezen aan handmatig werk dat AI kan vervangen, en besloten er iets aan te doen.",
      story: "AKJ.ai is gebouwd op één overtuiging: krachtige AI-automatisering mag geen enterprise-budgetten of tijdlijnen van zes maanden vereisen. We bouwen lean, we werken snel en we blijven totdat uw systeem echte, meetbare resultaten oplevert.",
      values: [
      ...
      founders: [
        {
          ...
          specialty: "AI-engineering & Systeemarchitectuur",
          bio: "Wiskunde, Technologie & Economie aan AUC. Competitief tennisatleet. Bouwt de AI-infrastructuur achter elk cliëntsysteem.",
          initials: "AÁ",
          school: "Amsterdam University College",
        },
        {
          name: "Justin Kuijper",
          role: "Medeoprichter & COO",
          specialty: "Strategie & Klantensucces",
          bio: "Wiskunde & Economie aan AUC · GPA 8,5. Michelinster-precisie in elke oplevering. Verantwoordelijk voor strategie en operaties.",
          initials: "JK",
          school: "Amsterdam University College",
        },
        {
          name: "Alexander",
          role: "Medeoprichter & CBO",
          specialty: "Groei & Bedrijfsontwikkeling",
          bio: "Sociale Wetenschappen & Economie aan AUC. Drijft partnerships, klantrelaties en commerciële groei.",
          initials: "AK",
          school: "Amsterdam University College",
        },
      ],
    ...
    faq: {
      ...
      ctaTitle: "Nog vragen?",
      ctaDesc: "Boek een gratis gesprek van 30 minuten en we beantwoorden alles — geen pitch, gewoon duidelijkheid.",
      ctaBtn: "Boek een gratis gesprek",
      items: [
        {
    ...
    contact: {
      ...
      extraLabel: "Welk proces kost u op dit moment de meeste tijd?",
      extraPh: "bijv. Rapportage, onboarding, lead-follow-up…",
      emails: [
    ...
    footer: {
      ...
      brandDesc: "AI-automatiseringsagentschap opgericht door Adrián Álvarez Sande, Justin Kuijper en Alexander.",
    ...
    home: {
      metrics: [
        { value: "1–3 wkn",  label: "Gemiddelde lanceertijd" },
        { value: "60%+",     label: "Minder handmatig werk" },
        { value: "24 / 7",   label: "AI-agenten altijd actief" },
        { value: "100+",     label: "Automatiseringen ingezet" },
      ],
      servicesGrid: {
        badge: "Wat we automatiseren",
        title: "AI-systemen gebouwd",
        titleAccent: "voor elk bedrijf",
        subtitle: "Zeven bewezen AI-systemen, elk bedrijf, elke sector. Kies wat u nodig heeft — wij bouwen en verbinden alles.",
        cta: "Bekijk alle 7 diensten",
        learnMore: "Meer weten",
        tiles: [
          { label: "AI-chatbots",               desc: "Web, WhatsApp & social media" },
          { label: "AI-spraakagenten",           desc: "Automatische gespreksafhandeling" },
          { label: "Werkstroomautomatisering",   desc: "End-to-end procesautomatisering" },
          { label: "CRM & Leadbeheer",           desc: "Vastleggen, scoren & opvolgen" },
          { label: "Afspraken boeken",           desc: "24/7 zelfbediening" },
          { label: "API-integraties",            desc: "Stripe, Notion, HubSpot & meer" },
          { label: "Aangepaste AI-agenten",      desc: "Gebouwd voor uw exacte bedrijf" },
        ],
      },
      process: {
        badge: "Ons proces",
        title: "Eenvoudig proces.",
        titleAccent: "snelle resultaten.",
        subtitle: "Vier stappen van eerste gesprek tot een live AI-systeem — geen verrassingen, geen vertragingen.",
        prev: "← Vorige",
        next: "Volgende →",
        steps: [
          { num: "01", title: "Gratis ontdekkingsgesprek", desc: "30 minuten. We leren uw bedrijf kennen, brengen in kaart wat geautomatiseerd kan worden en kijken of er een match is.", detail: "U weet na het gesprek precies welke systemen zinvol zijn voor uw bedrijf en hoe de ROI eruitziet — ook als u ons niet inhuurt." },
          { num: "02", title: "Maatwerk voorstel",         desc: "Een helder plan: wat we bouwen, hoe het werkt, de prijs en de tijdlijn. Geen vage scope.", detail: "Vaste prijs, duidelijke deliverables, geen upsells. We bakenen het project goed af zodat beide partijen weten wat succes inhoudt." },
          { num: "03", title: "Bouwen & integreren",       desc: "We bouwen uw AI-systeem, verbinden het met uw tools en testen alles vóór de lancering.", detail: "Alle integraties worden end-to-end getest in een testomgeving voordat we uw live data aanraken." },
          { num: "04", title: "Lancering & support",       desc: "Live in 1–3 weken. 30 dagen monitoring en aanpassingen na de lancering inbegrepen.", detail: "Na de lancering bewaken we de prestaties, lossen we randgevallen op en stemmen we het systeem af." },
        ],
      },
      pricingTeaser: {
        badge: "Prijzen",
        title: "Eenvoudige,",
        titleAccent: "transparante prijzen",
        subtitle: "Projecten tegen vaste prijs. Geen verborgen kosten. Geen maandelijkse abonnementen. Kies uw scope.",
        cta: "Bekijk volledige prijzen & deliverables",
        popularBadge: "Meest populair",
        tiers: [
          { name: "Starter",  price: "€150 – €400",   desc: "Eerste AI-automatisering. Eén probleem snel opgelost.",             cta: "Aan de slag" },
          { name: "Growth",   price: "€400 – €900",   desc: "Meerdere systemen die samenwerken om uren te besparen.",            cta: "Aan de slag", featured: true },
          { name: "Business", price: "€900 – €2.000", desc: "Volledig AI-ecosysteem voor een schaalbare operatie.",              cta: "Aan de slag" },
        ],
      },
      useCasesTeaser: {
        badge: "Toepassingen",
        ...
        titleAccent: "écht automatiseren",
        subtitle: "Echte scenario's. Echte resultaten. Geen sector valt buiten de boot.",
        cta: "Bekijk alle 6 toepassingen",
        items: [
          { icon: "💬", tag: "Sales & Leads",              title: "Mis nooit meer een lead",          desc: "Een prospect stuurt 's avonds een bericht — uw AI reageert direct, kwalificeert de lead en plant een gesprek in. Terwijl u slaapt.", outcome: "Gem. 3× meer leads vastgelegd" },
          { icon: "📞", tag: "Boeking & Operaties",        title: "Telefoontjes op automatische piloot", desc: "Uw AI-spraakagent neemt elk gesprek aan, plant afspraken in en stuurt bevestigingen — 24/7, geen wachtmuziek.", outcome: "Nul gemiste gesprekken" },
      ...
      cta: {
        ...
        titleAccent: "gesprek van 30 min.",
        desc: "We brengen in kaart wat AI precies voor uw bedrijf kan doen. Geen verplichting, geen pitch — gewoon een helder gesprek.",
        btn1: "Boek een gratis gesprek",
        btn2: "Bekijk onze diensten",
        social: "Reageert doorgaans binnen 24 uur",
      },
      liveDemo: {
        badge: "Zie het werken",
        title: "Uw AI reageert terwijl",
        titleAccent: "u slaapt.",
        subtitle: "Een klant stuurt om 23:00 een bericht. Uw AI kwalificeert, reageert en boekt — in seconden. Geen mens nodig.",
        eventLabel: "Geautomatiseerde acties",
        statText: "Dit alles gebeurde in minder dan 8 seconden — automatisch, terwijl u niet beschikbaar was.",
        cta: "Bouw dit voor mijn bedrijf",
      },
    },
  },
};
