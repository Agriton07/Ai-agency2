    ...
    <section style={{ background: "var(--bg-tertiary)", padding: "96px 0 112px" }}>
      <div style={{ maxWidth: "1160px", margin: "0 auto", padding: "0 24px" }}>
        ...
        <motion.div ref={ref} variants={STAGGER} initial="hidden" animate={inView ? "visible" : "hidden"}>
          ...
          <motion.div variants={fadeUp}>
            <div className="hiw-grid" style={{ display: "grid", gridTemplateColumns: "300px 1fr", gap: "20px", alignItems: "start" }}>
              <div className="hiw-sidebar" style={{ background: "var(--bg-secondary)", borderRadius: "20px", padding: "10px", border: "1px solid var(--border)", display: "flex", flexDirection: "column", gap: "4px" }}>
                {h.steps.map((s, i) => (
